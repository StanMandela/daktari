 ...
 * @property Authentication      $authentication						Boleto Class
 * @property Base_model	    	 $base_model								Boleto Class
 * @property Data_model    		 $data_model									Boleto Class
 * @property Learning_model    		 $learning_model									Boleto Class
 * @property Admin    		 $admin									Boleto Class
 * @property Base    		 $base									Boleto Class
 * @property Courses   		 $courses									Boleto Class
 */
class CI_Controller {
