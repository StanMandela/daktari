...
|           $config['auth_override_class_method']['dash.php']['*'] = 'none|digest|basic';
|
| Here 'deals', 'accounts' and 'dash.php' are controller names, 'view', 'insert' and 'user' are methods within. An asterisk may also be used to specify an authentication method for an entire classes methods. Ex: $config['auth_override_class_method']['dash.php']['*'] = 'basic'; (NOTE: leave off the '_get' or '_post' from the end of the method name)
...
// $config['auth_override_class_method']['deals']['insert'] = 'digest';
// $config['auth_override_class_method']['accounts']['user'] = 'basic';
// $config['auth_override_class_method']['dash.php']['*'] = 'basic';
