					...
					<div class="row">
						<div class="col-lg-5">
							<div class="d-none d-lg-block" style="position: relative;" data-height-xl="413" >
								<img src="<?php echo base_url()?>assets/imgs/doctor1.png" alt="Image" style="position: absolute; bottom: -65px;">
							</div>
						</div>
						...
						<div class="form-widget col-lg-7">
							...
							<form class="row mb-0" id="template-medical-form" name="template-medical-form" action="https://formspree.io/f/xyyopkjn" method="post">
								...
								<div class="col-md-4 form-group">
									...
									<input type="text" id="template-medical-phone" name=" Patient phone" class="form-control not-dark required" value="">
								</div>
								<div class="w-100"></div>
								<div class="col-md-8 form-group">
									<label for="template-medical-email">Email Address:</label>
									<input type="email" id="template-medical-email" name="Patient email" class="form-control not-dark required" value="">
								</div>
								<div class="col-md-4 form-group">
									<label for="template-medical-dob">Date of Birth:</label>
									<input type="text" id="template-medical-dob" name="Patient dob" class="form-control not-dark required" value="" placeholder="DD/MM/YYYY">
								</div>
								<div class="w-100"></div>
								<div class="col-md-5">
									<div class="row">
										<div class="col-12 form-group">
											...
											<input type="text" id="template-medical-appoint-date" name="tPatient appointment-date" class="form-control not-dark required" value="" placeholder="DD/MM/YYYY">
										</div>
										<div class="col-12 form-group">
											<label for="template-medical-second-booking">Booked with us Before?</label><br>
											<label class="rightmargin-sm">
												<input type="radio" id="template-medical-second-booking" name="Has Patient booked with Us before?" value="yes">
												Yes
											</label>
											<label>
												<input type="radio" name="Has Patient booked with Us before?" value="no" checked>
												No
											</label>
										</div>
									</div>
								...
								<div class="col-md-7 form-group">
									...
									<textarea id="template-medical-message" name="Patient Message" class="form-control not-dark required" cols="30" rows="5"></textarea>
								</div>
								<div class="w-100"></div>
								...
								<div class="col-12 form-group text-end">
									<button class ="button button-reveal button-large button-circle text-end m-0" >Confirm Booking</button></a>
								</div>
							</form>
